...
import 'package:byebye_flutter_app/services/firebase_auth_service.dart';
import 'package:byebye_flutter_app/services/mock_auth_service.dart';
...
//
  @override
  Future<User> signInWithGoogle() async => await authService.signInWithGoogle();
